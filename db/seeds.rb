...
PostImage.find_or_create_by!(flower: "椿") do |post_image|
  ...
  post_image.detail = "一年を通してさまざまな花を見る事ができる市内での有名な植物園ですね。特に椿はさまざまな種類のものを見る事ができ、
  この植物園でしか見れない種類のものもありました。"
...
PostImage.find_or_create_by!(flower: "牡丹") do |post_image|
...
PostImage.find_or_create_by!(flower: "梅") do |post_image|
  ...
  post_image.detail = "八幡山に蝋梅園がありました、蝋梅園まではロープウェイで行くことができますが、混雑時は１時間以上待ちますので、
  時間には余裕を持って行動して下さい。また夕暮れ時は蝋梅が夕日を浴びて黄金に輝く幻想的な景色が楽しめますよ。"
...
PostImage.find_or_create_by!(flower: "桜") do |post_image|
  ...
  post_image.detail = "毎年お花見客で賑わう春日部公園、今年もすごい人混みでした。公園入ってすぐのところの桜が特に綺麗な色をしていて、
  やっぱりそこだけお花見客とでごったがえしてます。あと近くのコンビニですが、やはりこの時期は混みすぎて入れません。"
...
PostImage.find_or_create_by!(flower: "藤") do |post_image|
...
PostImage.find_or_create_by!(flower: "躑躅") do |post_image|
  ...
  post_image.detail = "境内にいたる所に躑躅が咲いていて、また有料で入園できる躑躅園もあります。でも躑躅園って入ってから気が付くんですけど、、、
  入るよりも遠くから眺めている方が良く見えるんですよねぇ、、、。"
...
PostImage.find_or_create_by!(flower: "紫陽花") do |post_image|
...
PostImage.find_or_create_by!(flower: "百合") do |post_image|
  ...
  post_image.detail = "金沢ドームから歩いてしばらくしたところにあります。あと近くのコンビニなんですけど、ちょうど私が行った時に金沢ドームのコンサートがあったみたいで、
  お客さんでもの凄い列ができてました。もしも行く予定がある方はコンサートの閉演時間なんかの事前に確認が必要かもしれません。"
...
PostImage.find_or_create_by!(flower: "向日葵") do |post_image|
  ...
  post_image.detail = "まず最寄り駅からのバスの乗り場がすごく分かりづらくて、どうやら違うバス乗ってしまい到着までにものすごい時間がかかりました。
  またバス停を降りてからもひまわり畑の入口が分かりづらくて、丁度ひまわり畑周りをの一周してようやく入り口の存在に気付きました。
  でも不思議ですね、、、こんなに広いの場所ににこんなに迷うなんて。"
...
PostImage.find_or_create_by!(flower: "曼珠沙華") do |post_image|
  ...
  post_image.detail = "四国でも有名な花の名所ですね。曼珠沙華は葉が無いので満開時には真っ赤な絨毯ができます。
  あと何故か公園の周りを流れる川で泳ぐ人たちが続出してます。9月下旬でしたがまだまだ暑かったです。"
...
PostImage.find_or_create_by!(flower: "秋桜") do |post_image|
  ...
  post_image.detail = "しものせき花の国はとても広いなので、園内を移動するだけでも普通に1時間かかります。
  入園の際には目的地を事前に確認して、最寄りのゲートから入園しないと大変なことになります。"
...
PostImage.find_or_create_by!(flower: "菊") do |post_image|
  ...
  post_image.detail = "多くの菊が展示されています。近所の小学校の生徒さん達が育てた菊も展示されてます、
  大河ドラマの登場人物を模した菊人形なども菊の花の用いたものが多く展示されてました。"
